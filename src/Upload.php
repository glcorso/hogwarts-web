...
class Upload
{
    ...
    protected $lang = array(
        'upload_userfile_not_set' => "Não foi possível encontrar a variável de POST chamada userfile.",
        'upload_file_exceeds_limit' => "O arquivo enviado excede o valor máximo permitido no arquivo de configuração do PHP.",
        'upload_file_exceeds_form_limit' => "O arquivo enviado excede o valor máximo permitido pelo formulário.",
        'upload_file_partial' => "O arquivo foi enviado apenas parcialmente.",
        'upload_no_temp_directory' => "O diretório temporário não foi encontrado.",
        'upload_unable_to_write_file' => "Não foi possível salvar o arquivo.",
        'upload_stopped_by_extension' => "O envio do arquivo foi interrompido por uma extensão.",
        'upload_no_file_selected' => "Nenhum arquivo foi selecionado.",
        'upload_invalid_filetype' => "O tipo do arquivo selecionado não é permitido.",
        'upload_invalid_filesize' => "O tamanho do arquivo selecionado é maior do que o permitido.",
        'upload_invalid_dimensions' => "A imagem selecionada excede a largura e altura máximas.",
        'upload_destination_error' => "Não foi possível mover o arquivo enviado para seu diretório de destino.",
        'upload_no_filepath' => "O diretório de destino não é válido.",
        'upload_no_file_types' => "Nenhum tipo permitido de arquivo foi especificado.",
        'upload_bad_filename' => "O nome do arquivo selecionado já existe no servidor.",
        'upload_not_writable' => "Não há permissão de escrita para o diretório de destino do arquivo."
    );
	// --------------------------------------------------------------------
