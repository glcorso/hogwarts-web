<?php
namespace Lidere\Console\Scheduling;
...
class Event {
    ...
    protected function runCommandInForeground(Container $container)
    {
        ...
        $process = new Process(
            trim($this->buildCommand(), '& '), APP_ROOT, null, null, null
        );
        $process->run();
    ...
    {
        return APP_ROOT.'storage'.DS.'schedule'.DS.md5($this->expression.$this->command);
    }

    /**
     * Determine if the given event should run based on the Cron expression.
     *
     * @param  \Lidere\Application  $app
     * @return bool
     */
