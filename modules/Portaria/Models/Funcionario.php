 ...
 * @subpackage AssistenciaExterna\Models\Funcionario
 * @author     William Mascarello <william.mascarello@lideresistemas.com.br>
 * @copyright  2020 Lidere Sistemas
 * @license    Copyright (c) 2020
 * @link       https://www.lideresistemas.com.br/license.md
 */
class Funcionario extends OracleEloquent
{
    protected $core;
    protected $connection;

    public $table = 'tsdi_pessoas';
    ...
    public static function criar($input = null)
    {
        ...
        try {
            ...
            $funcinario->codigo = $input['codigo'];
            $funcinario->descricao = $input['descricao'];
            $funcinario->situacao = $input['situacao'];
            $funcinario->save();
        } catch(\Exception $e) {
            //$e->get
