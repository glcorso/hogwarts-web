 ...
 * @subpackage Veiculos\Services
 * @author William Mascarello
 * @copyright 2020 Lidere Sistemas
 */
class Veiculos extends Services
{
    /**
    ...
    public function list($pagina = 1)
    {
        ...
        try{
            ...
            /* Total sem paginação  */
            $total = Veiculo::where($filtros)->count();
    ...
    public function add()
    {
        $concorrente = Veiculo::criar($this->input);
    ...
    public function edit()
    {
        ...
        $row = Veiculo::find($this->input['id']);
    ...
    public function delete()
    {
        ...
        $deleted = Veiculo::whereId($this->input['id'])->delete();
        return $deleted;
    }
