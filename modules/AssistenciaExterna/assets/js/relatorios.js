relatoriosJs = {
    onReady: function() {
        ...
        $('.btn-filtrar-rel-def').on('click', function(){
            $('.form-filtro').attr('action', '/assistencia-externa/relatorios/ocorrencias-por-item').removeAttr('target').submit();
        });

        $('.btn-imprimir-rel-def').on('click', function(){
            $('.form-filtro').attr('action', '/assistencia-externa/relatorios/ocorrencias-por-item/imprimir').attr('target', '_blank').submit();
        });
