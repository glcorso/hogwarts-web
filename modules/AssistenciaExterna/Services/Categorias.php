 ...
 * @subpackage Categorias\Services
...
class Categorias extends Services
{
    ...
    public function list($pagina = 1)
    {
        ...
        try{
            ...
            /* Total sem paginação  */
            $total = Categoria::where($filtros)->count();
    ...
    public function add()
    {
        $concorrente = Categoria::criar($this->input);
    ...
    public function edit()
    {
        ...
        $row = Categoria::find($this->input['id']);
    ...
    public function delete()
    {
        ...
        $deleted = Categoria::whereId($this->input['id'])->delete();
        return $deleted;
    }
