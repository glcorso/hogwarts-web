 ...
 * @link       https://www.lideresistemas.com.br/license.md
 */
class TAvisosSetores extends OracleEloquent
{
    protected $core;
    protected $connection;

    public $table = 'tsdi_avisos_setores';
    ...
    public static function criar($input = null)
    {
        $avisoSetor = null;
        try {
            $avisoSetor = new TAvisosSetores();
            $avisoSetor->aviso_id = $input['aviso_id'];
            $avisoSetor->setor_id = $input['setor_id'];
            $avisoSetor->save();
        } catch(\Exception $e) {
